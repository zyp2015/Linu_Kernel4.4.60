...
static struct ftrace_ops *ftrace_control_list   = &ftrace_list_end;
...
static struct hlist_head ftrace_func_hash[FTRACE_FUNC_HASHSIZE]  ;
...
static struct ftrace_ops trace_probe_ops   =
{
...
unsigned long ftrace_graph_funcs[FTRACE_GRAPH_MAX_FUNCS]  ;
