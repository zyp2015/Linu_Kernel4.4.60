...
int sysctl_perf_event_mlock   = 512 + (PAGE_SIZE / 1024); /* 'free' kiB per user */
...
int sysctl_perf_event_sample_rate  	= DEFAULT_MAX_SAMPLE_RATE;

static int max_samples_per_tick  	= DIV_ROUND_UP(DEFAULT_MAX_SAMPLE_RATE, HZ);
static int perf_sample_period_ns  	= DEFAULT_SAMPLE_PERIOD_NS;
...
int sysctl_perf_cpu_time_max_percent   = DEFAULT_CPU_TIME_MAX_PERCENT;
