...
static   uint32_t amd_counters_base;
static   uint32_t amd_ctrls_base;
static   int amd_msr_step;
static   int k7_counters_mirrored;
static   int amd_num_counters;
...
static   int intel_num_arch_counters, intel_num_fixed_counters;
