...
static unsigned int ip_list_hash_size  ;
static unsigned int ip_list_perms   = 0644;
static unsigned int ip_list_uid  ;
static unsigned int ip_list_gid  ;
...
static unsigned int ip_pkt_list_tot  ;
...
static struct xt_match recent_mt_reg[]   = {
	{
		.name       = "recent",
		.revision   = 0,
		.family     = NFPROTO_IPV4,
