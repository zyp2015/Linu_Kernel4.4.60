...
static int window   = 8;
static unsigned int backoff_beta   = 0.7071 * 1024; /* sqrt 0.5 */
static unsigned int backoff_factor   = 42;
static unsigned int hystart_detect   = 3;
static unsigned int use_ineff   = 5;
static bool use_shadow   = true;
static bool use_tolerance  ;
