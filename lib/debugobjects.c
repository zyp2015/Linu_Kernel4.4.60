...
static int			debug_objects_maxchain  ;
static int			debug_objects_fixups  ;
static int			debug_objects_warnings  ;
static int			debug_objects_enabled  
				= CONFIG_DEBUG_OBJECTS_ENABLE_DEFAULT;

static struct debug_obj_descr	*descr_test   ;
